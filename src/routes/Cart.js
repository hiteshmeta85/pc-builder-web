import {Box, Button, Divider, Flex, Heading, Image, Img, Stack, Text, useToast,} from "@chakra-ui/react";
      ...
      return (<>
        ...
        {ordersInfo.length === 0 ? <Box maxW='1360px' mx='auto' py='0.5rem' px={{base: '1rem', md: '2rem'}}>
          ...
          <Flex justifyContent='space-between' pt={3}>
            <Text fontSize='2rem' color='gray.500' fontWeight='semibold'>Cart</Text>
            <Button bg='green.400' color='white' onClick={handleClick} mr={5}
                    _hover={{bg: 'green.500'}} _focus={{bg: 'green.400'}}
                ...
                >
                  ...
                  <Stack
                    ...
                    <Box fontWeight={600} color={'gray.500'} fontSize="sm" mb={4}>
                      ...
                      <Text textAlign={'start'}>
                        <Text as='span' color='black'>Motherboard:</Text> {item.Motherboard}
                      </Text>
                      <Text textAlign={'start'}>
