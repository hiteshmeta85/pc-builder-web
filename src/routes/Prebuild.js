  ...
  return (
    <>
      <Box maxW='1360px' mx='auto' px={{base: '1rem', md: '2rem'}} py={12}>
        <Text bgClip='text' bgGradient='linear(to-l, purple.300, purple.900)' lineHeight='100%' fontSize={{base: '2rem', lg: '5rem'}} textAlign='center' fontWeight='semibold' letterSpacing='2px'>
          Pre Build PCs
        </Text>
        ...
        {prebuilds.map((item) => {
          return (
            <Box py={8} key={item.id}>
              <Text bgClip='text' bgGradient='linear(to-l, gray.300, gray.900)' lineHeight='120%' fontSize={{base: '2rem', lg: '4rem'}} textAlign='center' fontWeight='semibold' letterSpacing='2px'>
                {item.type}
              </Text>
              <TableContainer>
                <Table>
